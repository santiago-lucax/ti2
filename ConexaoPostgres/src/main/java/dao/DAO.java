...
public class DAO {
	...
	public boolean inserir(Alunos aluno) {
		...
		ConnectionDB db = new ConnectionDB(); // Objeto para conexao com BD
	...
	public List<Alunos> listar() {
		...
		ConnectionDB db = new ConnectionDB(); // Objeto de conexao
    ...
    public boolean atualizar(Alunos aluno) {
        ...
        ConnectionDB db = new ConnectionDB(); // Objeto para conexao
